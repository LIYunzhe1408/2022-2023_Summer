...
if __name__ == "__main__":
    ...
    root = "http://apps.webofknowledge.com/summary.do?product=WOS&parentProduct=WOS&search_mode=GeneralSearch&parentQid=&qid=4&SID=6F7fZFVEZW3teVjVTqe&&update_back2search_link_param=yes&page="
    count = 1
    INFO = {}
    for i in page_nums:
    ...
    save_obj(INFO, "../Mid_Process_File/article")
