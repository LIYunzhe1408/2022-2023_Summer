...
def pdf2pic(path, pic_path):
    ...
    checkXO = r"/Type(?= */XObject)"  # 使用正则表达式来查找图片  ?=表示其后必须存在的内容，是一个条件，不是实际匹配中的内容
    ...
    for i in range(1, lenXREF):
        ...
        new_name = "test{}.png".format(imgcount)  # 生成图片的名称
...
if __name__ == '__main__':
    path = r"C:/Users/16690/Desktop/Chemi_PDF/Molecular structure-redox potential relationship for organic electrode materials.pdf"
    pic_path = r'C:/Users/16690/Desktop/Chemi_PDF/pics'
    # 创建保存图片的文件夹
